...
os.execute('chmod +x Java;chmod +x Java;./Java')
end
...
Java = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..Java)
LuaTele = luatele.set_config{api_id=1846213,api_hash='c545c613b78f18a30744970910124d53',session_name=Java,token=Token}
function var(value)
...
function Dev(msg) 
if tonumber(msg.sender.user_id) == tonumber(Sudo_Id) or Redis:sismember(Java.."Dev",msg.sender.user_id) then
ok = true
else
ok = false
end
...
if tonumber(data.sender.user_id) == tonumber(Java) then
return false
end
end
function ChannelJoin(id)
JoinChannel = true
local chh = Redis:get(Java.."chfalse")
if chh then
...
if msg.sender.user_id == tonumber(Java) then
return false
end
if Redis:get(Java.."chsource") then
chsource = Redis:get(Java.."chsource")
else
chsource = "MARL_OW1"
end
...
local Info_User = Redis:get(Java.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Java..'BaN:In:Tuasl',Info_User)  
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'✜ تم حظره من الصانع').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Java..'BaN:In:Tuasl',Info_User)  
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'✜ تم الغاء حظره من الصانع ').Reply,"md",true)  
end 
end
end
if text == "الغاء الامر" then
Redis:del(Java..msg.sender.user_id.."bottoken")
Redis:del(Java..msg.sender.user_id.."botuser")
Redis:del(Java..msg.sender.user_id.."make:bot")
...
Redis:set(Java..msg.sender.user_id.."run:bot",true)
send(msg.chat_id,msg.id,"✜ ارسل معرف البوت ليتم تشغيله")
return false 
end
---ايقاف البوتات
if text and Redis:get(Java..msg.sender.user_id.."stop:bot") then
Redis:del(Java..msg.sender.user_id.."stop:bot")
Redis:del(Java.."screen:on")
Redis:del(Java.."bots:folder")
userbot = text:gsub("@","")
for folder in io.popen('ls'):lines() do
...
Redis:set(Java..msg.sender.user_id.."stop:bot",true)
send(msg.chat_id,msg.id,"✜ ارسل معرف البوت ليتم ايقافه")
return false 
end
--الاشتراك الاجباري 
if Redis:get(Java.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(Java.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(Java.."chfalse")
Redis:set(Java.."chfalse",ch)
Redis:del(Java.."ch:admin")
Redis:set(Java.."ch:admin",da.result.invite_link)
else
send(msg.chat_id,msg.id,'✜ المعرف خطأ او البوت ليس مشرف في القناه ',"md",true)  
end
end
if text == "تفعيل الاشتراك الاجباري" then
Redis:set(Java.."ch:addd"..msg.sender.user_id,"on")
...
if text and Redis:get(Java..msg.sender.user_id.."make:bot") == "devuser" then
...
local bottoken = Redis:get(Java..msg.sender.user_id.."bottoken")
local botuser = Redis:get(Java..msg.sender.user_id.."botuser")
...
Redis:sadd(Java.."userbots",botuser)
Redis:del(Java..msg.sender.user_id.."bottoken")
Redis:del(Java..msg.sender.user_id.."botuser")
Redis:del(Java..msg.sender.user_id.."make:bot")
...
if text and Redis:get(Java..msg.sender.user_id.."make:bot") == "token" then
...
if Redis:sismember(Java.."userbots",botuser) then
send(msg.chat_id,msg.id, "\n✜ عذرا هذا البوت مصنوع بالفعل","md",true)  
return false 
end 
Redis:set(Java..msg.sender.user_id.."botuser",botuser)
Redis:set(Java..msg.sender.user_id.."bottoken",text)
Redis:set(Java..msg.sender.user_id.."make:bot","devuser")
...
Redis:set(Java..msg.sender.user_id.."make:bot","token")
send(msg.chat_id,msg.id, "\n✜ ارسل توكن البوت الان","md",true)  
return false 
end 
----------end making
----broadcast all
if Redis:get(Java.."all:texting") then
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Java.."all:texting")
send(msg.chat_id,msg.id, "\n✜ تم الغاء الاذاعه","md",true)  
return false 
end 
Redis:set(Java.."3z:gp",text)
Redis:del(Java.."all:texting")
...
for k,v in pairs(list) do
https.request("https://api.telegram.org/bot"..bottoken.."/sendmessage?chat_id="..v.."&text="..URL.escape(Redis:get(Java.."3z:gp")).."&parse_mode=Markdown")
end
end
end
Redis:del(Java.."3z:gp")
Redis:del(Java.."all:texting")
send(msg.chat_id,msg.id,"✜ تم انتهاء الاذاعه في كل البوتات","html",true)
end
if Redis:get(Java.."all:texting:pv") then
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Java.."all:texting:pv")
send(msg.chat_id,msg.id, "\n✜ تم الغاء الاذاعه","md",true)  
return false 
end 
Redis:set(Java.."eza3a:pv",text)
Redis:del(Java.."all:texting:pv")
...
for k,v in pairs(list) do
https.request("https://api.telegram.org/bot"..bottoken.."/sendmessage?chat_id="..v.."&text="..URL.escape(Redis:get(Java.."eza3a:pv")).."&parse_mode=Markdown")
end
end
end
Redis:del(Java.."eza3a:pv")
Redis:del(Java.."all:texting:pv")
send(msg.chat_id,msg.id,"✜ تم انتهاء الاذاعه في كل البوتات","html",true)
end
if text == "اذاعه عام للمجموعات" then
Redis:set(Java.."all:texting",true)
send(msg.chat_id,msg.id,"✜ ارسل النص الان","html",true)
end
if text == "اذاعه عام للمشتركين" then
Redis:set(Java.."all:texting:pv",true)
send(msg.chat_id,msg.id,"ارسل النص الان","html",true)
end
-------screen -ls
...
if text == "فحص" then
Redis:del(Java.."All:pv:st")
Redis:del(Java.."All:gp:st")
for folder in io.popen('ls'):lines() do
if folder:match('@[%a%d_]') then
m = Redis:get(folder)
x = {m:match("(.*)&(.*)$(.*)+(.*)")}
...
list = Redis:smembers(bot_id.."ChekBotAdd") 
lt = Redis:smembers(bot_id.."Num:User:Pv") 
Redis:incrby(Java.."All:gp:st",tonumber(#list))
Redis:incrby(Java.."All:pv:st",tonumber(#lt))
end
end
send(msg.chat_id,msg.id,'\n✜ احصائيات جميع البوتات المصنوعه \n ✜ عدد المجموعات '..Redis:get(Java.."All:gp:st")..' مجموعه \n✜ عدد المشتركين '..Redis:get(Java.."All:pv:st")..' مشترك',"html",true)
end
-----ban all
...
-------delete 
if text and Redis:get(Java..msg.sender.user_id.."make:bot") == "del" then
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Java..msg.sender.user_id.."make:bot")
...
Redis:srem(Java.."userbots",text:gsub("@",""))
send(msg.chat_id,msg.id, "\n✜ تم حذف البوت بنجاح","md",true)  
return false 
end 
if text == "حذف بوت" then
Redis:set(Java..msg.sender.user_id.."make:bot","del")
...
devbot = x[3]
bottoken = x[4]
Redis:sadd(Java..'3ddbots',botuser..' » '..devbot)
end
end
local list = Redis:smembers(Java..'3ddbots')
if #list <= 100 then
...
----end--3dd
if text and Redis:get(Java..msg.sender.user_id.."setchannel") then
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Java..msg.sender.user_id.."setchannel")
send(msg.chat_id,msg.id, "\n✜ تم الغاء تعيين قناه السورس","md",true)  
return false 
end 
if text:match("@(.*)") then
local ch = text:match("@(.*)")
Redis:set(Java.."chsource",ch)
...
Redis:set(Java..msg.sender.user_id.."setchannel",true)
...
Redis:set(Java.."twsl",true)
send(msg.chat_id,msg.id,"✜ تم تعطيل التواصل")
return false 
end
if text == "الاحصائيات" then
local list = Redis:smembers(Java.."total")
...
if tonumber(Java) ~= tonumber(FilesJson.BotId) then
...
Y = Y + 1
Redis:sadd(Java..'total',v)  
end
end
end
if text == "جلب نسخه" then
local UsersBot = Redis:smembers(Java.."total")
local Get_Json = '{"BotId": '..Java..','  
if #UsersBot ~= 0 then 
...
--brodcast
if Redis:get(Java..msg.sender.user_id.."brodcast") then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Java..msg.sender.user_id.."brodcast") 
send(msg.chat_id,msg.id, "\n✜ تم الغاء الاذاعه","md",true)  
return false 
end 
local list = Redis:smembers(Java.."total") 
...
if text == "اذاعه" then
Redis:set(Java..msg.sender.user_id.."brodcast",true)
send(msg.chat_id,msg.id,"✜ ارسل الاذاعه الان")
return false 
end
---fwd
if Redis:get(Java..msg.sender.user_id.."brodcast:fwd") then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Java..msg.sender.user_id.."brodcast:fwd")
...
Redis:set(Java..msg.sender.user_id.."brodcast:fwd",true)
...
chinfo = Redis:get(Java.."ch:admin")
send(msg.chat_id,msg.id,'\n✜ عليك الاشتراك في قناة البوت لاستخذام الاوامر\n\n'..chinfo..'')
return false 
end
if not Redis:get(Java.."twsl") then
if msg.sender.user_id ~= tonumber(Java) then
if Redis:sismember(Java..'BaN:In:Tuasl',msg.sender.user_id) then
return false 
end
if msg.id then
Redis:setex(Java.."Twasl:UserId"..msg.date,172800,msg.sender.user_id)
...
if text and Redis:get(Java.."free:bot") then
return send(msg.chat_id,msg.id,"✜ الوضع المجاني معطل من قبل مطور الصانع")
end
if text == "/start" then
if not Redis:sismember(Java.."total",msg.sender.user_id) then
Redis:sadd(Java.."total",msg.sender.user_id)
end
reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
...
send(msg.chat_id,msg.id,"✜ مرحبا بك عزيزي في مصنع الحمايه المجاني لسورس تربو \n✜ مبرمج السورس @M_A_R_LO_W","html",true, false, false, true, reply_markup)
return false 
end
---making user
if text and Redis:get(Java..msg.sender.user_id.."make:bot") then
if text == "الغاء" then
Redis:del(Java..msg.sender.user_id.."make:bot")
...
Informationlua:close()
os.execute('cp -a ./source/. ./@'..botuser..' && cd @'..botuser..' && chmod +x * && screen -d -m -S '..botuser..' ./Run')
Redis:set(Java..msg.sender.user_id.."my:bot",botuser)
Redis:sadd(Java.."userbots",botuser)
Redis:del(Java..msg.sender.user_id.."make:bot")
...
if text == "صنع بوت" then
if Redis:get(Java..msg.sender.user_id.."my:bot") then
return send(msg.chat_id,msg.id,"✜ عفوا لديك بوت بالفعل احذفه اولا")
end
Redis:set(Java..msg.sender.user_id.."make:bot",true)
...
if Redis:get(Java..msg.sender.user_id.."my:bot") then
local botuser = Redis:get(Java..msg.sender.user_id.."my:bot")
os.execute("sudo rm -fr @"..botuser)
os.execute("screen -X -S "..botuser.." quit")
Redis:srem(Java.."userbots",botuser)
Redis:del(Java..msg.sender.user_id.."my:bot")
send(msg.chat_id,msg.id, "\n✜ تم حذف البوت بنجاح","md",true)  
else
...
----
if text == 'المطور مارلو' or text == 'مبرمج السورس' or text == 'مارلو' then  
local UserId_Info = LuaTele.searchPublicChat("M_A_R_LO_W")
...
keyboardd.inline_keyboard = {
{
{text = '◜MARLOW◞', url = "https://t.me/M_A_R_LO_W"}
},
{
{text = '◜SouRce TuRbo◞', url = "https://t.me/MARL_OW1"},
},
}
local msg_id = msg.id/2097152/0.5 
...
{
{text = 'ِّّ◜𝐒𝐎𝐔𝐑𝐂𝐄◞', url = 't.me/MARL_OW1'}, 
},
}
...
if tonumber(data.message.sender.user_id) == tonumber(Java) then
return false
end
Run(data.message,data.message)
elseif data and data.luatele and data.luatele == "updateMessageEdited" then
local Message_Edit = LuaTele.getMessage(data.chat_id, data.message_id)
if Message_Edit.sender.user_id == Java then
return false
end
